...
export default {
	...
	[Types.PUT_TOCACHE](state: Inspect.State, payload: Inspect.classPage) {
	...
	[Types.SET_CACHE_PAGES](state: Inspect.State, payload: Inspect.classPage[]) {
		vueX2stoage("cachePages", payload);
		state.cachePages = payload;
	},
